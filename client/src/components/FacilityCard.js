/**
 * FacilityCard Component - Refactored
 * Presentational component for displaying facility information
 */
...
import QueueBadge from './ui/QueueBadge';
import { getPriceRange, getMockDistance, formatDistance } from '../utils/helpers';
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <QueueBadge queueCount={facility.queueCount} size="small" />
      </View>
      ...
      <View style={styles.detailsGrid}>
        <View style={styles.detailCard}>
          ...
          <View>
            ...
            <Text style={styles.detailValue}>{getPriceRange(facility.services)}</Text>
          </View>
        </View>
